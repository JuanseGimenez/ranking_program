...
test.expect(file.matches, [[%w[Lions 4], %w[Snakes 3]],
                           [%w[Tarantulas 1], ['FC Awesome', '0']],
                           [%w[Lions 1], ['FC Awesome', '1']],
                           [%w[Tarantulas 3], %w[Snakes 1]],
                           [%w[Lions 4], %w[Grouches 0]],
                           [%w[Tarantulas 1], %w[Grouches 1]],
                           [%w[Snakes 4], %w[Grouches 2]],
                           [['FC Awesome', '3'], %w[Snakes 2]]])
